...
@XmlRootElement(name = "valida_praiaResponse", namespace = "http://default_package/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "valida_praiaResponse", namespace = "http://default_package/")

public class Valida_praiaResponse {
