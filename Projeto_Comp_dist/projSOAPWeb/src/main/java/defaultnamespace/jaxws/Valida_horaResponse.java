...
@XmlRootElement(name = "valida_horaResponse", namespace = "http://default_package/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "valida_horaResponse", namespace = "http://default_package/")

public class Valida_horaResponse {
